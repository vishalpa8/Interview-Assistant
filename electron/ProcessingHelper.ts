    ...
    if (view === "queue") {
      ...
      if (lastPath.endsWith('.mp3') || lastPath.endsWith('.wav')) {
        ...
        try {
          ...
          logError('ProcessingHelper.analyzeAudioFromBase64', err)
      ...
      try {
        ...
        logError('ProcessingHelper.processScreenshots', error, { screenshotCount: screenshotQueue.length })
      ...
      try {
        ...
        logError('ProcessingHelper.processDebugScreenshots', error, { extraScreenshotCount: extraScreenshotQueue.length })
