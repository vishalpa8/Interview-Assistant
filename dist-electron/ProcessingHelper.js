        ...
        if (view === "queue") {
            ...
            if (lastPath.endsWith('.mp3') || lastPath.endsWith('.wav')) {
                ...
                try {
                    ...
                    (0, ErrorLogger_1.logError)('ProcessingHelper.analyzeAudioFromBase64', err);
            ...
            try {
                ...
                (0, ErrorLogger_1.logError)('ProcessingHelper.processScreenshots', error, { screenshotCount: screenshotQueue.length });
            ...
            try {
                ...
                (0, ErrorLogger_1.logError)('ProcessingHelper.processDebugScreenshots', error, { extraScreenshotCount: extraScreenshotQueue.length });
