...
// Better development detection - check if we're running with vite
const isDev = process.env.NODE_ENV === "development" || !process.env.NODE_ENV || __dirname.includes('dist-electron') === false;
...
class WindowHelper {
    ...
    createWindow() {
        ...
        // this.mainWindow.webContents.openDevTools() // Uncomment for debugging
        ...
        this.mainWindow.loadURL(startUrl).catch((err) => {
            (0, ErrorLogger_1.logError)('WindowHelper', err, { url: startUrl, isDev });
        });
